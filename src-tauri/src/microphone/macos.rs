// Microphone input and stream for macOS
// This is a placeholder - full implementation would use CoreAudio
use anyhow::Result;
...
impl MicrophoneStream {
    ...
    fn capture_audio_loop(
        ...
        // TODO: Implement CoreAudio microphone capture
        let _ = init_tx.send(Err(anyhow::anyhow!(
            "macOS microphone capture not yet implemented"
        )));
        Ok(())
    }
}
